...
use AppBundle\Entity\Packages\Relations\CheckDependency;
use AppBundle\Entity\Packages\Relations\Conflict;
use AppBundle\Entity\Packages\Relations\Dependency;
use AppBundle\Entity\Packages\Relations\MakeDependency;
use AppBundle\Entity\Packages\Relations\OptionalDependency;
use AppBundle\Entity\Packages\Relations\Provision;
use AppBundle\Entity\Packages\Relations\Replacement;
...
class Package implements \JsonSerializable
{
     ...
     * @var Packager
     *
     * @ORM\Embedded(class="AppBundle\Entity\Packages\Packager")
     */
     ...
     *
     * @ORM\OneToMany(
     *     targetEntity="AppBundle\Entity\Packages\Relations\Replacement",
     *     mappedBy="source",
     *     cascade={"persist"},
     *     orphanRemoval=true
     * )
     ...
     *
     * @ORM\OneToMany(
     *     targetEntity="AppBundle\Entity\Packages\Relations\Conflict",
     *     mappedBy="source",
     *     cascade={"persist"},
     *     orphanRemoval=true
     * )
     ...
     *
     * @ORM\OneToMany(
     *     targetEntity="AppBundle\Entity\Packages\Relations\Provision",
     *     mappedBy="source",
     *     cascade={"persist"},
     *     orphanRemoval=true
     * )
     ...
     *
     * @ORM\OneToMany(
     *     targetEntity="AppBundle\Entity\Packages\Relations\Dependency",
     *     mappedBy="source",
     *     cascade={"persist"},
     *     orphanRemoval=true
     * )
     ...
     *
     * @ORM\OneToMany(
     *     targetEntity="AppBundle\Entity\Packages\Relations\OptionalDependency",
     *     mappedBy="source",
     *     cascade={"persist"},
     *     orphanRemoval=true
     * )
     ...
     *
     * @ORM\OneToMany(
     *     targetEntity="AppBundle\Entity\Packages\Relations\MakeDependency",
     *     mappedBy="source",
     *     cascade={"persist"},
     *     orphanRemoval=true
     * )
     ...
     *
     * @ORM\OneToMany(
     *     targetEntity="AppBundle\Entity\Packages\Relations\CheckDependency",
     *     mappedBy="source",
     *     cascade={"persist"},
     *     orphanRemoval=true
     * )
    ...
    /**
     * @param Repository $repository
     * @param \AppBundle\ArchLinux\Package $databasePackage
     * @return Package
     */
    public static function createFromPackageDatabase(
        Repository $repository,
        \AppBundle\ArchLinux\Package $databasePackage
    ): Package {
        $package = new self(
            $repository,
     ...
     * @return Package
     */
    public function updateFromPackageDatabase(\AppBundle\ArchLinux\Package $databasePackage): Package
    {
