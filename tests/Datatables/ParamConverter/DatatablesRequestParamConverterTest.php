...
namespace App\Tests\Datatables\ParamConverter;

use App\Datatables\DatatablesRequest;
use App\Datatables\ParamConverter\DatatablesRequestParamConverter;
...
class DatatablesRequestParamConverterTest extends TestCase
{
    ...
    public function testDatatablesRequestIsAttachedToRequest(): void
    {
    ...
    {
        /** @var ConstraintViolationList<ConstraintViolationInterface>|MockObject $constraintViolationList */
    ...
    public function testParamconverterSupportsDatatablesRequest(): void
    {
        $this->configureValidator(0);
    ...
    public function testValidationErrorsPreventAttachmentToRequest(): void
    {
     ...
     */
    public function testSearch(bool $isRegex): void
    {
        $this->configureValidator(0);
        ...
        $this->assertNotNull($datatablesRequest->getSearch());
     ...
     */
    public function testColumn(bool $searchable, bool $orderable, bool $isRegex): void
    {
        $this->configureValidator(0);
     ...
     */
    public function testOrderColumn(string $orderDirection): void
    {
        $this->configureValidator(0);
    ...
    public function testRequestIsInitialized(): void
    {
        $this->configureValidator(0);
