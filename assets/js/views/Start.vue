...
<script>
import PackageSearch from '@/js/components/PackageSearch'
import NewsItemList from '@/js/components/NewsItemList'
import RecentPackages from '@/js/components/RecentPackages'
