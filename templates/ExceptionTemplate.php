...
<body>
	...
	<div id="content">
		...
		<p><?php echo sprintf($l10n->getText('I am sorry, something went wrong while processing file %s'), '<strong>'.basename($e->getFile(), '.php').'</strong>.'); ?></p>
		<p><?php echo sprintf($l10n->getText('Contact %s'), '<a href="mailto:'.Config::get('common', 'email').'">'.Config::get('common', 'email').'</a>'); ?></p>
		</div>
		<div id="footer">
			<?php echo $l10n->getTextFile('PageFooter'); ?>
		</div>
	</div>
</body>
</html>
